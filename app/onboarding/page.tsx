  ...
  return (
    <main className="relative min-h-screen overflow-x-hidden bg-black text-white">
      ...
      <div
        ...
        aria-hidden="true"
      >
        <div className="absolute left-1/2 top-16 h-[700px] w-[700px] -translate-x-1/2 rounded-full bg-[radial-gradient(circle,rgba(57,255,20,0.12)_0%,transparent_68%)]" />
      ...
      <div className="relative mx-auto flex w-full max-w-[480px] flex-col items-center px-5 pb-12 pt-4 sm:px-6 sm:pt-6">
        ...
        <section
          className="animate-onboarding-fade relative mb-0 w-full"
          aria-label="Don't Over Train"
        >
          <div className="relative mx-auto h-[520px] w-full overflow-hidden sm:h-[580px] md:h-[640px] lg:h-[700px]">
            <Image
              ...
              priority
              sizes="100vw"
              className="object-contain object-top scale-[1.08]"
            />
            {/* Logo INSIDE */}
            <div className="absolute left-1/2 top-[14%] z-20 -translate-x-1/2">
              <Image
                ...
                width={220}
                height={220}
                className="w-[160px] sm:w-[180px] md:w-[210px] h-auto drop-shadow-[0_12px_30px_rgba(0,0,0,.75)]"
              />
            </div>
        ...
        {/* Guest CTA */}
        <div className="animate-onboarding-rise-delay-1 -mt-14 w-full">
        <button
          type="button"
